...
public class PointFunctionOld {
    public double x1,x2;
    public double y1,y2;

    public PointFunctionOld(double x1, double x2, double y1, double y2){
        this.x1=x1;
        this.x2=x2;
        this.y1=y1;
        this.y2=y2;
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Coordinates first PointFunctionOld " + "=" + point.x1 + "," + point.x2);
        System.out.println("Coordinates second PointFunctionOld " + "=" + point.y1 + "," + point.y2);
        System.out.println("Distance beetween Point1 and Point2 = " + point.distance());

        PointFunctionOld point1 =new PointFunctionOld(3,7,6,11);
        System.out.println("Coordinates first PointFunctionOld " + "=" + point1.x1 + "," + point1.x2);
        System.out.println("Coordinates second PointFunctionOld " + "=" + point1.y1 + "," + point1.y2);
